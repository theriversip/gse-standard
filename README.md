...
## Zero Copula
The verb equivalent to “be” in General American English (GAE) may be absent in non-emphatic contexts. 
...
## Negation
GSE often omits the auxiliary do in questions and past tense. Often tense and negation are carried directly on `ain’t` or another marker. The `aint`  negator can substitute for multiple GAE auxiliaries (isn’t, didn’t, hasn’t, etc.).

| GSE              | GAE meaning             |
| ---------------- | ----------------------- |
| She õ want that. | She does not want that. |
| She aĩ want that | She did not want that.  |
| You õ have to.   | You don't have to.      |
...
| He béen workin.                                   | He has been working for a long time now.                             |
| He been workin.                                   | He has been working as of late.                                      |
| I béen knew that.                                 | I've known that for a long time now.                                 |
...
| GSE                        | GAE meaning                                                       |
| -------------------------- | ----------------------------------------------------------------- |
| He béen done had it.       | He has had it for a long time (and it’s finished/over/completed). |
| She be done gone.          | She’s usually already gone.                                       |
...
Existentials usually use *it* or *ain’t no* constructions.

| GSE Standard           | GAE                       |
| ---------------------- | ------------------------- |
| It's a lot.            | There is a lot.           |
| It aĩ no...            | There is no...            |
| It aĩ nobody in there. | There is nobody in there. |
